...
class Ball(Updatable, Gravitational):
    def __init__(self, radius=random.randrange(5,10), fill_color=(random.randint(0,255),random.randint(0,255), random.randint(0,255)), border_color=(random.randint(0,255),random.randint(0,255), random.randint(0,255)), density=random.randrange(0,10), position:Vect2D=(random.randrange(0,100),random.randrange(0,100)), speed:Vect2D=(0,0), acceleration:Vect2D=(0,0), bounce=0.95, friction=0.95):
...
class Game(Updatable):
    ...
    def __init__(self, size, nb_balls=10, ball_min_radius=5, ball_max_radius=40, ball_min_speed=1, ball_max_speed=10):
        super().__init__()
        self.__size = size
        ...
        for _ in range(self.__nb_balls):
            self.__balls.append(Ball(random.randrange(self.__ball_min_radius, self.__ball_max_radius), "red", "blue", random.randrange(5, 50), Vect2D(random.randrange(0, self.__size.x), random.randrange(0, self.__size.y)), Vect2D(random.randrange(self.__ball_min_speed, self.__ball_max_speed), random.randrange(self.__ball_min_speed, self.__ball_max_speed)), Vect2D(0, 0)))
